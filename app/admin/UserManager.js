...
export default function UserManager() {
  ...
  // Users aur Courses fetch karein
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="flex justify-between items-center bg-[#0D1117] p-6 rounded-3xl border border-white/5 shadow-2xl">
                ...
                <td className="p-5 text-right">
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      ...
                      className="p-2.5 bg-white/5 rounded-xl text-slate-400 hover:text-red-500 transition-colors"
                      title="Delete User"
                    >
                      <Trash2 size={16} />
                    </button>
